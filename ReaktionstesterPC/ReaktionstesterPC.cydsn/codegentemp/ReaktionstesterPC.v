// ======================================================================
// ReaktionstesterPC.v generated from TopDesign.cysch
// 05/05/2021 at 17:39
...
`ifdef WARP
`define CY_BLK_DIR "C:\Program Files (x86)\Cypress\PSoC Creator\4.4\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\PRS_v2_40"
`include "C:\Program Files (x86)\Cypress\PSoC Creator\4.4\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\PRS_v2_40\PRS_v2_40.v"
`else
`define CY_BLK_DIR "C:\Program Files (x86)\Cypress\PSoC Creator\4.4\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\PRS_v2_40"
`include "C:\Program Files (x86)\Cypress\PSoC Creator\4.4\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\PRS_v2_40\PRS_v2_40.v"
`endif
...
module top ;
	...
	wire [0:0] tmpOE__RxD_PC_net;
	wire [0:0] tmpIO_0__RxD_PC_net;
	wire [0:0] tmpINTERRUPT_0__RxD_PC_net;
	electrical [0:0] tmpSIOVREF__RxD_PC_net;
	...
	cy_psoc3_pins_v1_10
		...
		RxD_PC
		 (.oe(tmpOE__RxD_PC_net),
		  .y({1'b0}),
		  .fb({Net_5}),
		  .io({tmpIO_0__RxD_PC_net[0:0]}),
		  .siovref(tmpSIOVREF__RxD_PC_net),
		  .interrupt({tmpINTERRUPT_0__RxD_PC_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__RxD_PC_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__TxD_PC_net;
	wire [0:0] tmpFB_0__TxD_PC_net;
	wire [0:0] tmpIO_0__TxD_PC_net;
	wire [0:0] tmpINTERRUPT_0__TxD_PC_net;
	electrical [0:0] tmpSIOVREF__TxD_PC_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("ed092b9b-d398-4703-be89-cebf998501f6"),
		  ...
		  .input_buffer_sel(2'b00))
		TxD_PC
		 (.oe(tmpOE__TxD_PC_net),
		  .y({Net_9}),
		  .fb({tmpFB_0__TxD_PC_net[0:0]}),
		  .io({tmpIO_0__TxD_PC_net[0:0]}),
		  .siovref(tmpSIOVREF__TxD_PC_net),
		  .interrupt({tmpINTERRUPT_0__TxD_PC_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__TxD_PC_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_clock_v1_0
		#(.id("9bae25a0-c151-4921-b633-709c0c5390b9"),
	...
	cy_clock_v1_0
		#(.id("c5037641-b2dc-4cc4-99be-3fe82e106d2a"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	wire [0:0] tmpOE__Pin_LED2_net;
	wire [0:0] tmpFB_0__Pin_LED2_net;
	wire [0:0] tmpIO_0__Pin_LED2_net;
	wire [0:0] tmpINTERRUPT_0__Pin_LED2_net;
	electrical [0:0] tmpSIOVREF__Pin_LED2_net;

	cy_psoc3_pins_v1_10
		#(.id("8679bfd9-eb27-4eca-8b35-d987b28be763"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_LED2
		 (.oe(tmpOE__Pin_LED2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_LED2_net[0:0]}),
		  .io({tmpIO_0__Pin_LED2_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_LED2_net),
		  .interrupt({tmpINTERRUPT_0__Pin_LED2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_LED2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_LED3_net;
	wire [0:0] tmpFB_0__Pin_LED3_net;
	wire [0:0] tmpIO_0__Pin_LED3_net;
	wire [0:0] tmpINTERRUPT_0__Pin_LED3_net;
	electrical [0:0] tmpSIOVREF__Pin_LED3_net;

	cy_psoc3_pins_v1_10
		#(.id("8a2316c7-8501-4035-b389-14f2ff85005b"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	assign tmpOE__Pin_LED3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_LED4_net;
	wire [0:0] tmpFB_0__Pin_LED4_net;
	wire [0:0] tmpIO_0__Pin_LED4_net;
	wire [0:0] tmpINTERRUPT_0__Pin_LED4_net;
	electrical [0:0] tmpSIOVREF__Pin_LED4_net;

	cy_psoc3_pins_v1_10
		#(.id("c795d83b-b3fa-4670-9a26-1a641c03f6b8"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	assign tmpOE__Pin_LED4_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_BiggerButton_net;
	wire [0:0] tmpIO_0__Pin_BiggerButton_net;
	wire [0:0] tmpINTERRUPT_0__Pin_BiggerButton_net;
	electrical [0:0] tmpSIOVREF__Pin_BiggerButton_net;

	cy_psoc3_pins_v1_10
		#(.id("bab1e220-f470-4ebb-8357-11a6cc587c90"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_BiggerButton
		 (.oe(tmpOE__Pin_BiggerButton_net),
		  .y({1'b0}),
		  .fb({Net_36}),
		  .io({tmpIO_0__Pin_BiggerButton_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_BiggerButton_net),
		  .interrupt({tmpINTERRUPT_0__Pin_BiggerButton_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_BiggerButton_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
