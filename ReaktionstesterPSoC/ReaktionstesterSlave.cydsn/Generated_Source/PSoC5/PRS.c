        ...
        *******************************************************************************/
                                            ...
                                            
        {
            ...
            enableInterrupts = CyEnterCriticalSection();
                ...
                /* Write Seed COPY */
                CY_SET_REG24(PRS_SEED_COPY_PTR, seed);
    ...
    *******************************************************************************/
    uint32 PRS_Read(void) 
    {
        /* Read PRS */
            ...
            return (CY_GET_REG24(PRS_SEED_PTR) & PRS_MASK);
    ...
    *******************************************************************************/
    void PRS_WriteSeed(uint32 seed) 
    {
        ...
        /* Writes Seed */
            ...
            CY_SET_REG24(PRS_SEED_PTR, seed);
    ...
    *******************************************************************************/
                                ...
                                
    {
        /* Reads polynomial */
            ...
            return CY_GET_REG24(PRS_POLYNOM_PTR);
    ...
    *******************************************************************************/
                                          ...
                                          
    {
        ...
        /* Write polynomial */
            ...
            CY_SET_REG24(PRS_POLYNOM_PTR, polynomial);
