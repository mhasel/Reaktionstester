...
void PRS_Sleep(void) ;
    ...
    uint32 PRS_Read(void) ;
    void PRS_WriteSeed(uint32 seed)  ;
    uint32 PRS_ReadPolynomial(void) 
                                ;
    void PRS_WritePolynomial(uint32 polynomial) 
                                          ;
    ...
    #if (PRS_PRS_SIZE <= 32u) /* 8-32 bits PRS */
        void PRS_ResetSeedInit(uint32 seed)  
                                            ;
    #else
...
#if (PRS_PRS_SIZE <= 32u)
    #define PRS_DEFAULT_POLYNOM            (0xCA000u)
    #define PRS_DEFAULT_SEED               (0xFFFFFu)
    
#else
    #define PRS_DEFAULT_POLYNOM_UPPER      (0x0u)
    #define PRS_DEFAULT_POLYNOM_LOWER      (0xCA000u)
    #define PRS_DEFAULT_SEED_UPPER         (0x0u)
    #define PRS_DEFAULT_SEED_LOWER         (0xFFFFFu)
...
***************************************/
    ...
    #define PRS_EXECUTE_STEP       \
        ...
        #define PRS_SEED_LOWER_COPY_A__A0_PTR      	( (reg8 *) PRS_b0_PRSdp_a__F0_REG )
        ...
        #if (PRS_PRS_SIZE <= 32u)         /* 8-32 bits PRS */
            /* Polynomial */
            #define PRS_POLYNOM_PTR      ( (reg32 *)\
                                                PRS_sC24_PRSdp_u0__D0_REG )
            /* Seed */
            #define PRS_SEED_PTR         ( (reg32 *)\
                                                PRS_sC24_PRSdp_u0__A0_REG )
            /* Seed COPY */
            #define PRS_SEED_COPY_PTR    ( (reg32 *)\
                                                PRS_sC24_PRSdp_u0__F0_REG )
            ...
            /* Polynomial */
            #define PRS_POLYNOM_PTR      ( (reg32 *)\
                                            PRS_sC24_PRSdp_u0__16BIT_D0_REG )
            /* Seed */
            #define PRS_SEED_PTR         ( (reg32 *)\
                                            PRS_sC24_PRSdp_u0__16BIT_A0_REG )
            /* Seed COPY */
            #define PRS_SEED_COPY_PTR    ( (reg32 *)\
                                            PRS_sC24_PRSdp_u0__16BIT_F0_REG )
            ...
            /* Polynomial */
            #define PRS_POLYNOM_PTR      ( (reg32 *)\
                                            PRS_sC24_PRSdp_u0__32BIT_D0_REG )
            /* Seed */
            #define PRS_SEED_PTR         ( (reg32 *)\
                                            PRS_sC24_PRSdp_u0__32BIT_A0_REG )
            /* Seed COPY */
            #define PRS_SEED_COPY_PTR    ( (reg32 *)\
                                            PRS_sC24_PRSdp_u0__32BIT_F0_REG )
